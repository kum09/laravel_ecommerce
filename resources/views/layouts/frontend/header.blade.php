...
<!-- Mirrored from themesbrand.com/toner/html/frontend/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Sep 2023 10:50:15 GMT -->
<head>
        ...
        <!--Swiper slider css-->
        <link href="{{asset('public/build/assets/frontend/libs/swiper/swiper-bundle.min.css')}}" rel="stylesheet" type="text/css" />

        <!-- Bootstrap Css -->
        <link href="{{asset('public/build/assets/frontend/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css">
        <!-- Icons Css -->
        <link href="{{asset('public/build/assets/frontend/css/icons.min.css')}}" rel="stylesheet" type="text/css">
        <!-- App Css-->
        <link href="{{asset('public/build/assets/frontend/css/app.min.css')}}" rel="stylesheet" type="text/css">
        <!-- custom Css-->
        <link href="{{asset('public/build/assets/frontend/css/custom.min.css')}}" rel="stylesheet" type="text/css">
    ...
    <div class="w-100">
        ...
        <nav class="navbar navbar-expand-lg ecommerce-navbar" id="navbar">
            <div class="container">
                <a class="navbar-brand d-none d-lg-block" href="index.html">
                    <div class="logo-dark">
                        <img src="{{asset('public/build/assets/frontend/images/logo-dark.png')}}" alt="" height="25">
                    </div>
                    <div class="logo-light">
                        <img src="{{asset('public/build/assets/frontend/images/logo-light.png')}}" alt="" height="25">
                    </div>
                </a>
                    ...
                    <ul class="navbar-nav mx-lg-auto mb-2 mb-lg-0" id="navigation-menu">
                        <li class="nav-item d-block d-lg-none">
                            <a class="d-block p-3 h-auto text-center" href="index.html">
                                <img src="{{asset('public/build/assets/frontend/images/logo-dark.png')}}" alt="" height="25" class="card-logo-dark mx-auto">
                                <img src="{{asset('public/build/assets/frontend/images/logo-light.png')}}" alt="" height="25" class="card-logo-light mx-auto">
                            </a>
                        </li>
                            ...
                            <div class="dropdown-menu p-0">
                                <div class="row g-0 g-lg-4">
                                    <div class="col-lg-2 d-none d-lg-block">
                                        <div class="card rounded-start rounded-0 border-0 h-100 mb-0 overflow-hidden" style="background-image: url('{{asset('public/build/assets/frontend/images/ecommerce/img-1.jpg')}}');background-size: cover;">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-lg-4">
                                                    <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                        <img src="{{asset('public/build/assets/frontend/images/brands/img-8.png')}}" alt="" class="avatar-sm">
                                                    </a>
                                                </div>
                                                <div class="col-lg-4">
                                                    <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                        <img src="{{asset('public/build/assets/frontend/images/brands/img-2.png')}}" alt="" class="avatar-sm">
                                                    </a>
                                                </div>
                                                <div class="col-lg-4">
                                                    <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                        <img src="{{asset('public/build/assets/frontend/images/brands/img-3.png')}}" alt="" class="avatar-sm">
                                                    </a>
                                                </div>
                                                <div class="col-lg-4">
                                                    <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                        <img src="{{asset('public/build/assets/frontend/images/brands/img-4.png')}}" alt="" class="avatar-sm">
                                                    </a>
                                                </div>
                                                <div class="col-lg-4">
                                                    <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                        <img src="{{asset('public/build/assets/frontend/images/brands/img-5.png')}}" alt="" class="avatar-sm">
                                                    </a>
                                                </div>
                                                <div class="col-lg-4">
                                                    <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                        <img src="{{asset('public/build/assets/frontend/images/brands/img-6.png')}}" alt="" class="avatar-sm">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="dropdown-menu dropdown-mega-menu-xl dropdown-menu-center p-0">
                                <div class="row g-0 g-lg-4">
                                    <div class="col-lg-5 d-none d-lg-block">
                                        <div class="card rounded-start rounded-0 border-0 h-100 mb-0 overflow-hidden" style="background-image: url('{{asset('public/build/assets/frontend/images/ecommerce/img-2.jpg')}}'); background-size: cover;">
                        ...
                        <li class="nav-item dropdown dropdown-hover">
                            ...
                            <ul class="dropdown-menu dropdown-menu-md dropdown-menu-center dropdown-menu-list submenu">
                                ...
                                <li class="nav-item">
                                    <a href="https://themesbrand.com/toner/html/components/index.html" class="nav-link" target="_blank" data-key="t-components">Components <span class="badge bg-danger align-bottom ms-1">1.0</span></a>
                                </li>
                                <li class="nav-item dropdown dropdown-hover">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown header-item dropdown-hover-end">
                        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="{{asset('public/build/assets/frontend/images/users/avatar-1.jpg')}}" alt="Header Avatar">
                        </button>
                                ...
                                <div class="flex-shrink-0">
                                    <div class="avatar-md" style="height: 100%;">
                                        <div class="avatar-title bg-warning-subtle rounded-3">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-4.png')}}" alt="" class="avatar-sm">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex-shrink-0">
                                    <div class="avatar-md" style="height: 100%;">
                                        <div class="avatar-title bg-info-subtle rounded-3">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-1.png')}}" alt="" class="avatar-sm">
                                        </div>
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="avatar-md" style="height: 100%;">
                                        <div class="avatar-title bg-danger-subtle rounded-3">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-6.png')}}" alt="" class="avatar-sm">
                                        </div>
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="avatar-md" style="height: 100%;">
                                        <div class="avatar-title bg-primary-subtle rounded-3">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-8.png')}}" alt="" class="avatar-sm">
                                        </div>
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="list-group list-group-flush border-dashed">
                                ...
                                <div class="notification-group-list">
                                    ...
                                    <a href="javascript:void(0);" class="list-group-item dropdown-item notify-item">
                                        <div class="d-flex align-items-center">
                                            <img src="{{asset('public/build/assets/frontend/images/users/avatar-1.jpg')}}" alt="" class="avatar-xs rounded-circle flex-shrink-0 me-2">
                                            <div>
                                    ...
                                    <a href="javascript:void(0);" class="list-group-item dropdown-item notify-item">
                                        <div class="d-flex align-items-center">
                                            <img src="{{asset('public/build/assets/frontend/images/users/avatar-7.jpg')}}" alt="" class="avatar-xs rounded-circle flex-shrink-0 me-2">
                                            <div>
                                    ...
                                    <a href="javascript:void(0);" class="list-group-item dropdown-item notify-item">
                                        <div class="d-flex align-items-center">
                                            <img src="{{asset('public/build/assets/frontend/images/users/avatar-5.jpg')}}" alt="" class="avatar-xs rounded-circle flex-shrink-0 me-2">
                                            <div>
                ...
                <div class="modal-content border-0">
                    <div class="modal-body p-0 bg-info-subtle rounded">
                        <div class="row g-0 align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="p-4 pb-0">
                                    <img src="{{asset('public/build/assets/frontend/images/subscribe.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <a href="https://themesbrand.com/toner/html/backend/index.html" class="btn btn-warning position-fixed bottom-0 start-0 m-5 z-3 btn-hover d-none d-lg-block"><i class="bi bi-database align-middle me-1"></i> Backend</a>
                                ...
                                <li class="chat-list left">
                                    <div class="conversation-list">
                                        <div class="chat-avatar">
                                            <img src="{{asset('public/build/assets/frontend/images/logo-sm.png')}}" alt="">
                                        </div>
