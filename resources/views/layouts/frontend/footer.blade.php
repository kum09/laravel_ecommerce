<section class="section footer-landing pb-0">
        ...
        <!-- JAVASCRIPT -->
        <script src="{{asset('public/build/assets/frontend/libs/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
        <script src="{{asset('public/build/assets/frontend/libs/simplebar/simplebar.min.js')}}"></script>
        <script src="{{asset('public/build/assets/frontend/js/plugins.js')}}"></script>

        <!-- isotope-layout -->
        <script src="{{asset('public/build/assets/frontend/libs/isotope-layout/isotope.pkgd.min.js')}}"></script>

        <!--Swiper slider js-->
        <script src="{{asset('public/build/assets/frontend/libs/swiper/swiper-bundle.min.js')}}"></script>
        
        <!-- Countdown js -->
        <script src="{{asset('public/build/assets/frontend/js/pages/coming-soon.init.js')}}"></script>
        
        <script src="{{asset('public/build/assets/frontend/js/frontend/landing-index.init.js')}}"></script>

        <script src="{{asset('public/build/assets/frontend/js/frontend/menu.init.js')}}"></script>

    </body>


<!-- Mirrored from themesbrand.com/toner/html/frontend/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Sep 2023 10:50:41 GMT -->
</html>