            ...
            <div id="ecommerceHero" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="ecommerce-home bg-danger-subtle" style="background-image: url('{{asset('public/build/assets/frontend/images/ecommerce/home/img-1.png')}}');">
                            <div class="container">
                    ...
                    <div class="carousel-item">
                        <div class="ecommerce-home bg-primary-subtle" style="background-image: url('{{asset('public/build/assets/frontend/images/ecommerce/home/img-2.png')}}');">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div>
                    ...
                    <div class="carousel-item">
                        <div class="ecommerce-home" style="background-image: url('{{asset('public/build/assets/frontend/images/ecommerce/home/img-6.jpg')}}');background-size: cover;">
                            <div class="container">
                                <div class="row justify-content-end">
                                    <div class="col-lg-6">
                                        <div class="text-end">
            ...
            <div class="container">
                <div class="row gy-4 gy-lg-0">
                    <div class="col-lg-3 col-sm-6">
                        <div class="d-flex align-items-center gap-3">
                            <div class="flex-shrink-0">
                                <img src="{{asset('public/build/assets/frontend/images/ecommerce/fast-delivery.png')}}" alt="" class="avatar-sm">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="d-flex align-items-center gap-3">
                            <div class="flex-shrink-0">
                                <img src="{{asset('public/build/assets/frontend/images/ecommerce/returns.png')}}" alt="" class="avatar-sm">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="d-flex align-items-center gap-3">
                            <div class="flex-shrink-0">
                                <img src="{{asset('public/build/assets/frontend/images/ecommerce/guarantee-certificate.png')}}" alt="" class="avatar-sm">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="d-flex align-items-center gap-3">
                            <div class="flex-shrink-0">
                                <img src="{{asset('public/build/assets/frontend/images/ecommerce/24-hours-support.png')}}" alt="" class="avatar-sm">
                            </div>
                            <div class="flex-grow-1">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <a href="#!" class="product-banner-1 mt-4 mt-lg-0 rounded overflow-hidden position-relative d-block">
                            <img src="{{asset('public/build/assets/frontend/images/ecommerce/features/img-3.jpg')}}" class="img-fluid rounded" alt="">
                    ...
                    <div class="col-lg-6">
                        <a href="#!" class="product-banner-1 mt-4 mt-lg-0 rounded overflow-hidden position-relative d-block">
                            <img src="{{asset('public/build/assets/frontend/images/ecommerce/features/img-1.jpg')}}" class="img-fluid rounded" alt="">
                            <div class="product-content p-4">
                        ...
                        <div class="row gallery-wrapper mt-4 pt-2">
                                ...
                                <div class="card overflow-hidden">
                                    <div class="bg-warning-subtle rounded-top py-4">
                                        <div class="gallery-product">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-6.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                        </div>
                            ...
                            <div class="element-item col-xxl-3 col-xl-4 col-sm-6 seller hot" data-category="seller hot">
                                <div class="card overflow-hidden">
                                    <div class="bg-info-subtle rounded-top py-4">
                                        <div class="gallery-product">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-7.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                        </div>
                                        <div class="gallery-product-actions">
                                            <div class="mb-2">
                                                 <button type="button" class="btn btn-danger btn-sm custom-toggle" data-bs-toggle="button">
                            ...
                            <div class="element-item col-xxl-3 col-xl-4 col-sm-6 trendy" data-category="trendy">
                                <div class="card overflow-hidden">
                                    <div class="bg-danger-subtle rounded-top py-4">
                                        <div class="gallery-product">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-1.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                        </div>
                                        <div class="gallery-product-actions">
                                            <div class="mb-2">
                                                 <button type="button" class="btn btn-danger btn-sm custom-toggle" data-bs-toggle="button">
                            ...
                            <div class="element-item col-xxl-3 col-xl-4 col-sm-6 trendy" data-category="trendy">
                                <div class="card overflow-hidden">
                                    <div class="bg-warning-subtle rounded-top py-4">
                                        <div class="gallery-product">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-2.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                        </div>
                                        <div class="gallery-product-actions">
                                            <div class="mb-2">
                                                 <button type="button" class="btn btn-danger btn-sm custom-toggle" data-bs-toggle="button">
                            ...
                            <div class="element-item col-xxl-3 col-xl-4 col-sm-6 seller arrival" data-category="arrival">
                                <div class="card overflow-hidden">
                                    <div class="bg-danger-subtle rounded-top py-4">
                                        <div class="gallery-product">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-3.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                        </div>
                                        <p class="fs-11 fw-medium badge bg-primary py-2 px-3 product-lable mb-0">Best Arrival</p>
                                        <div class="gallery-product-actions">
                                            <div class="mb-2">
                            ...
                            <div class="element-item col-xxl-3 col-xl-4 col-sm-6 seller hot" data-category="seller hot">
                                <div class="card overflow-hidden">
                                    <div class="bg-success-subtle rounded-top py-4">
                                        <div class="gallery-product">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-4.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                        </div>
                                        <div class="gallery-product-actions">
                                            <div class="mb-2">
                                                 <button type="button" class="btn btn-danger btn-sm custom-toggle" data-bs-toggle="button">
                            ...
                            <div class="element-item col-xxl-3 col-xl-4 col-sm-6 project hot arrival" data-category="hot arrival">
                                <div class="card overflow-hidden">
                                    <div class="bg-info-subtle rounded-top py-4">
                                        <div class="gallery-product">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-8.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                        </div>
                                        <div class="gallery-product-actions">
                                            <div class="mb-2">
                                                 <button type="button" class="btn btn-danger btn-sm custom-toggle" data-bs-toggle="button">
                            ...
                            <div class="element-item col-xxl-3 col-xl-4 col-sm-6 trendy" data-category="trendy">
                                <div class="card overflow-hidden">
                                    <div class="bg-danger-subtle rounded-top py-4">
                                        <div class="gallery-product">
                                            <img src="{{asset('public/build/assets/frontend/images/products/img-5.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                        </div>
                                        <p class="fs-11 fw-medium badge bg-primary py-2 px-3 product-lable mb-0">Best Arrival</p>
                                        <div class="gallery-product-actions">
                                            <div class="mb-2">
        ...
        <section class="position-relative bg-danger-subtle bg-cta">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                       <div class="mt-lg-n5">
                            <img src="{{asset('public/build/assets/frontend/images/ecommerce/home/cta.png')}}" alt="" class="mt-lg-n4">
                       </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="swiper-wrapper pt-5">
                                ...
                                <div class="swiper-slide">
                                    <div class="card overflow-hidden">
                                        <div class="bg-dark-subtle rounded-top py-4">
                                            <div class="gallery-product">
                                                <img src="{{asset('public/build/assets/frontend/images/products/img-9.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card overflow-hidden">
                                        <div class="bg-warning-subtle rounded-top py-4">
                                            <div class="gallery-product">
                                                <img src="{{asset('public/build/assets/frontend/images/products/img-10.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card overflow-hidden">
                                        <div class="bg-primary-subtle rounded-top py-4">
                                            <div class="gallery-product">
                                                <img src="{{asset('public/build/assets/frontend/images/products/img-11.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card overflow-hidden">
                                        <div class="bg-danger-subtle rounded-top py-4">
                                            <div class="gallery-product">
                                                <img src="{{asset('public/build/assets/frontend/images/products/img-12.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card overflow-hidden">
                                        <div class="bg-secondary-subtle rounded-top py-4">
                                            <div class="gallery-product">
                                                <img src="{{asset('public/build/assets/frontend/images/products/img-14.png')}}" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div>
                            ...
                            <div class="swiper-wrapper my-5">
                                    ...
                                    <div class="client-box m-1">
                                        ...
                                        <div class="pt-4">
                                            <div class="d-flex align-items-center mt-4 pt-1">
                                                <img src="{{asset('public/build/assets/frontend/images/users/avatar-2.jpg')}}" alt="" class="avatar-sm rounded">
                                ...
                                <div class="swiper-slide mt-5">
                                    <div class="client-box m-1">
                                        ...
                                        <div class="pt-4">
                                            <div class="d-flex align-items-center mt-4 pt-1">
                                                <img src="{{asset('public/build/assets/frontend/images/users/avatar-7.jpg')}}" alt="" class="avatar-sm rounded">
                                                <div class="flex-grow-1 ms-3">
                                ...
                                <div class="swiper-slide">
                                    <div class="client-box m-1">
                                        ...
                                        <div class="pt-4">
                                            <div class="d-flex align-items-center mt-4 pt-1">
                                                <img src="{{asset('public/build/assets/frontend/images/users/avatar-8.jpg')}}" alt="" class="avatar-sm rounded">
                                                <div class="flex-grow-1 ms-3">
                                ...
                                <div class="swiper-slide mt-5">
                                    <div class="client-box m-1">
                                        ...
                                        <div class="pt-4">
                                            <div class="d-flex align-items-center mt-4 pt-1">
                                                <img src="{{asset('public/build/assets/frontend/images/users/avatar-10.jpg')}}" alt="" class="avatar-sm rounded">
                                                <div class="flex-grow-1 ms-3">
                ...
                <div class="row row-cols-lg-5 row-cols-md-3 row-cols-1 text-center justify-content-center align-items-center g-3 mt-5 pt-lg-5">
                    <div class="col">
                        <div class="client-images">
                            <a href="#!">
                                <img src="https://themesbrand.com/toner/html/assets/images/clients/paypal.svg" alt="client-img" class="mx-auto img-fluid d-block">
                            </a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="client-images">
                            <a href="#!">
                                <img src="https://themesbrand.com/toner/html/assets/images/clients/walmart.svg" alt="client-img" class="mx-auto img-fluid d-block">
                            </a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="client-images">
                            <a href="#!">
                                <img src="https://themesbrand.com/toner/html/assets/images/clients/spotify.svg" alt="client-img" class="mx-auto img-fluid d-block">
                            </a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="client-images">
                            <a href="#!">
                                <img src="https://themesbrand.com/toner/html/assets/images/clients/shopify.svg" alt="client-img" class="mx-auto img-fluid d-block">
                            </a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="client-images">
                            <a href="#!">
                                <img src="https://themesbrand.com/toner/html/assets/images/clients/lenovo.svg" alt="client-img" class="mx-auto img-fluid d-block">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <section class="section bg-light bg-opacity-50">
            <div class="container">
                ...
                <div class="row mt-5">
                    <div class="col-lg-4">
                        <div class="card overflow-hidden">
                            <img src="{{asset('public/build/assets/frontend/images/small/img-3.jpg')}}" class="img-fluid" alt="">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card overflow-hidden">
                            <img src="{{asset('public/build/assets/frontend/images/small/img-8.jpg')}}" class="img-fluid" alt="">
                            <div class="card-body">
                                <div class="entry-meta">
                    ...
                    <div class="col-lg-4">
                        <div class="card overflow-hidden">
                            <img src="{{asset('public/build/assets/frontend/images/small/img-6.jpg')}}" class="img-fluid" alt="">
                            <div class="card-body">
                                <div class="entry-meta">
            ...
            <div class="position-relative">
                <div class="row g-0 mt-5">
                    <div class="col">
                        <div class="insta-img">
                            <a href="#!" class="stretched-link">
                                <img src="{{asset('public/build/assets/frontend/images/ecommerce/instagram/img-1.jpg')}}" class="img-fluid" alt="">
                    ...
                    <div class="col">
                        <div class="insta-img">
                            <a href="#!" class="stretched-link">
                                <img src="{{asset('public/build/assets/frontend/images/ecommerce/instagram/img-2.jpg')}}" class="img-fluid" alt="">
                                <i class="ri-instagram-line"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col d-none d-md-block">
                        <div class="insta-img">
                            <a href="#!" class="stretched-link">
                                <img src="{{asset('public/build/assets/frontend/images/ecommerce/instagram/img-3.jpg')}}" class="img-fluid" alt="">
                                <i class="ri-instagram-line"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col d-none d-md-block">
                        <div class="insta-img">
                            <a href="#!" class="stretched-link">
                                <img src="{{asset('public/build/assets/frontend/images/ecommerce/instagram/img-4.jpg')}}" class="img-fluid" alt="">
                                <i class="ri-instagram-line"></i>
                            </a>
                        </div>
                    </div>
                    <div class="col d-none d-lg-block">
                        <div class="insta-img">
                            <a href="#!" class="stretched-link">
                                <img src="{{asset('public/build/assets/frontend/images/ecommerce/instagram/img-5.jpg')}}" class="img-fluid" alt="">
                                <i class="ri-instagram-line"></i>
                            </a>
                        </div>
                    </div>
                    <div class="col d-none d-lg-block">
                        <div class="insta-img">
                            <a href="#!" class="stretched-link">
                                <img src="{{asset('public/build/assets/frontend/images/ecommerce/instagram/img-6.jpg')}}" class="img-fluid" alt="">
                                <i class="ri-instagram-line"></i>
                            </a>
                        </div>
                    </div>
